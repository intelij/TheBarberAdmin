                ...
                <form class="form-horizontal" id="edit_offer_form" action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="my-0">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="{{__('Offer Title')}}" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="discount" class="form-control" placeholder="{{__('Offer Discount')}}">
