...
<div class="container-fluid mt--6 mb-5">
    <div class="row">
        <div class="col">
            ...
            <form action="{{url('/owner/report/user/filter')}}" method="post" class="ml-4" id="filter_revene_form">
                @csrf
                <div class="row  rtl-date-filter-row">
                    <div class="form-group col-3">
                        <input type="text" id="filter_date" value="{{old('filter_date',$pass)}}" name="filter_date" class="form-control" placeholder="-- Select Date --">
