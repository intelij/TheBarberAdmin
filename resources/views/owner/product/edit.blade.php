                                            ...
                                            <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                                <div class="p-20">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="{{$product->price}}" class="form-control" name="price" id="price" placeholder="{{__('Price')}}" >
                                                        @error('price')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="{{$product->quantity}}" class="form-control" name="quantity" id="quantity" placeholder="{{__('Quantity')}}" >
                                                        @error('quantity')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                        @enderror
                                                    </div>
