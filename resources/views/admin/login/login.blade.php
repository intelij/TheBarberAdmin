                ...
                <div class="col-md-6 p-0">
                    <div class="login">
                        <div class="center-box">
                            ...
                            <div class="form-wrap">
                                <form role="form"  class="pui-form" id="loginform"  method="POST" action="{{url('/admin/login/verify')}}">
                                @csrf
                                ...
                                <span class="signup-label">{{__("Owner Login : ")}} <a href="{{url('/owner/login')}}"> {{__('Login Now.')}} </a></span>
                            </div>
                        </div>
                    </div>
                </div>
