                    ...
                    <tbody class="list">
                        @if (count($orders) != 0)
                            @foreach ($orders as $key => $order)
                                <tr>
                                    <th>{{$key}}</th>
                                    <th><img src="{{$order->product->first_image??""}}" style="width: 50px; height: 50px; " /></th>
                                    ...
                                    <td class="table-actions">
                                        <a href="{{url('admin/order/'.$order->id)}}" class="table-action text-warning" data-toggle="tooltip" data-original-title="{{__('View Order')}}">
