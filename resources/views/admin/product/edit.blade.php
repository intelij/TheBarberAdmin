            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="mx-4 ">
                        ...
                        <form class="form-horizontal form" action="{{url('/admin/product/update/'.$product->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                                <div class="p-20">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$product->title}}" name="title" id="title" class="form-control" placeholder="{{__('Product Title')}}"  autofocus>
                                                        @error('title')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="description" id="description" placeholder="{{__('Description')}}">{{$product->description}}</textarea>
                                                        @error('description')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="salon_id" id="salon_id" data-placeholder='{{ __("-- Select Salon --")}}' placeholder='{{ __("-- Select Salon --")}}' >
                                                            <option  value="own" {{ $product->salon_id == "own" ? 'selected':'' }}>Own Product</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="category_id" id="category_id" data-placeholder='{{ __("-- Select Category --")}}' placeholder='{{ __("-- Select Category --")}}' >
                                                            @foreach ($categories as $category)
                                                                <option  value="{{$category->cat_id}}" {{ $product->category_id == $category->cat_id ? 'selected':'' }}>{{$category->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('category_id')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-control custom-radio mb-2">
                                                            <input type="radio" id="yes" name="is_active" value="1" class="custom-control-input" {{$product->is_active == 1 ? 'checked' : ""}}>
                                                            <label class="custom-control-label" for="yes">{{__('Yes')}}</label>
                                                        </div>
                                                        <div class="custom-control custom-radio mb-2">
                                                            <input type="radio" id="no" name="is_active" value="0" class="custom-control-input" {{$product->is_active == 0 ? 'checked' : ""}}>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="0" value="{{$product->price}}" class="form-control" name="price" id="price" placeholder="{{__('Price')}}" >
                                                        @error('price')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="0" value="{{$product->quantity}}" class="form-control" name="quantity" id="quantity" placeholder="{{__('Quantity')}}" >
                                                        @error('quantity')
                                                        <div class="invalid-div">{{ $message }}</div>
                                                        @enderror
                                                    </div>
